...
import RedisClient, { Cluster, ClusterNode, ClusterOptions, RedisOptions } from "iovalkey";

//#region packages/extension-redis/src/Redis.d.ts
...
declare class Redis implements Extension {
  ...
  onConfigure({
    instance
  }: onConfigurePayload): Promise<void>;
  private getKey;
  private pubKey;
  private subKey;
  private lockKey;
  ...
  afterLoadDocument({
    documentName,
    document
  }: afterLoadDocumentPayload): Promise<unknown>;
  /**
  ...
  onAwarenessUpdate({
    ...
    removed,
    document
  }: onAwarenessUpdatePayload): Promise<number | undefined>;
  /**
...
//#endregion
export { Configuration, Redis, RedisInstance };